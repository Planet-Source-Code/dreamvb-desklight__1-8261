...
Begin VB.Form frmPass1 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Label Label1 
         ...
         Caption         =   "Enter Password to Lock Desktop"
         BeginProperty Font 
 ...
 If Len(Text1(0).Text) < 1 Then
  ...
  MsgBox "Please Enter your password", vbInformation
   ...
   ElseIf Text1(1).Text = Text1(0).Text Then
    ...
    Main.TDeskTop False
    MsgBox "Desktop is now locked", vbInformation: Main.PasswordOn = True: Unload frmPass1
   Else
   MsgBox "Your password does not match what you entered", vbCritical
   Text1(0).Text = ""
   Text1(1).Text = ""
  End If
